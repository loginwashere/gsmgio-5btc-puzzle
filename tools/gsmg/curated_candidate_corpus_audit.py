...
EXCLUDED_WORDLISTS = {
    ...
    "phase382_1141_offset_candidates.txt": ("dedicated-audit", "Swept separately by phase382_1141_offset_audit.py (FINDINGS.md Phase 382) against DBBI/FAED; disposition closed negative."),
}
